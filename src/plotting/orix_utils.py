# synth_struct/src/plotting/orix_utils.py
...
def get_crystal_map_slice(crystal_map, dimensions, slice_idx=None, 
                          slice_direction='z'):
    """
...
def get_grain_average_orientations(microstructure, crystal_structure='cubic'):
    """
