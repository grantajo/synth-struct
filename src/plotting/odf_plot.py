# synth_struct/src/plotting/odf_plot.py
...
def plot_odf(ax, micro, crystal_structure='cubic', grain_subset=None, 
             projection='axangle', **scatter_kwargs):
    """
...
def create_odf_figure(micro, crystal_structure='cubic', grain_subset=None, projection='axangle',
                      filename=None, figsize=(5,5), dpi=150, title=None, **kwargs):
    """
    ...
    plot_odf(
        ax, micro, crystal_structure=crystal_structure,
        grain_subset=grain_subset, **kwargs
    )
