...
def rotate_stiffness_tensors_batch(C_base: np.ndarray, R_matrices: np.ndarray) -> np.ndarray:
    """
    ...
    if C_base.ndim == 2:
        ...
        raise ValueError(f"C_base must have shape (6, 6) or (n, 6, 6), got {C_base.shape}")
