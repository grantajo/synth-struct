# /synth_struct/src/synth_struct/stiffnes/stiffness_old.py
...
class Stiffness:
    ...
    @staticmethod
    def Hexagonal(
        microstructure, C11=162.4, C12=92.0, C13=69.0, C33=180.7, C44=46.7, noise=None
    ):
        """
        ...
        for grain_id, quat in quaternions.items():
            ...
            if noise is None:
                ...
                C11_noise, C12_noise, C13_noise, C33_noise, C44_noise = (
                    C11,
                    C12,
                    C13,
                    C33,
