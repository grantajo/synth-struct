...
class TestHexagonalTexture:
    ...
    def test_orientations_normalized_to_2pi(self):
        ...
        gen = HexagonalTexture(type='prismatic', degspread=50.0, seed=42)  # Large spread
        texture = gen.generate(micro)
    ...
    def test_spread_affects_distribution(self):
        ...
        gen_large = HexagonalTexture(type='prismatic', degspread=20.0, seed=43)  # Larger spread
    ...
    def test_prismatic_orientation(self):
        ...
        np.testing.assert_array_almost_equal(
            HEXAGONAL_ORIENTATIONS['prismatic'],
            expected
        )
    ...
    def test_basal_vs_prismatic_different_orientations(self):
        ...
        assert not np.array_equal(
            texture_basal.orientations,
            texture_prismatic.orientations
        )
        
        # Specifically, prismatic should have π/2 in second angle
        np.testing.assert_almost_equal(
            texture_prismatic.orientations[0, 1],
            np.pi / 2
        )
