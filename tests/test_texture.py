...
class TestTexture:
    ...
    def test_initialization_quat(self):
        ...
        texture = Texture(
            orientations=orientations, representation="quat", symmetry="hexagonal"
        )
    ...
    def test_initialization_rotmat(self):
        ...
        texture = Texture(
            orientations=orientations, representation="rotmat", symmetry="cubic"
        )
    ...
    def test_invalid_representation(self):
        ...
        with pytest.raises(ValueError, match="Unknown representation"):
            Texture(
                orientations=orientations, representation="invalid", symmetry="cubic"
            )
    ...
    def test_quat_to_euler_conversion(self):
        ...
        texture_quat = Texture(
            orientations=orientations, representation="quat", symmetry="cubic"
        )
    ...
    def test_round_trip_conversion_euler_quat(self):
        ...
        texture = Texture(
            orientations=original, representation="euler", symmetry="cubic"
        )
    ...
    @pytest.mark.parametrize(
        "symmetry", ["cubic", "hexagonal", "tetragonal", "orthorhombic"]
    )
    def test_various_symmetries(self, symmetry):
        """Test that various symmetry strings are accepted"""
        orientations = np.random.rand(5, 3)
        texture = Texture(
            orientations=orientations, representation="euler", symmetry=symmetry
        )
